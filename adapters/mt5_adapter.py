...
Stub implementation - MT5 adapter to be implemented.
"""
...
class MT5Adapter(BrokerAdapter):
    ...
    Stub implementation - requires MT5 Python package and terminal.
    """
    ...
    async def connect(self) -> bool:
        raise NotImplementedError("MT5Adapter not yet implemented")
